package com.shiva.pillu.a186asynctaskdownloadimagerotation;
...
//        asyncDownloadTask.execute (imagesUrl[i]);
        asyncDownloadTask.execute (editText.getText ().toString ());
    }
    ...
    private class AsyncDownloadTask extends AsyncTask<String, Integer, Bitmap> {
        ...
        protected void onPreExecute() {
            ...
            // getConfiguration ().orientation  will return the orientation of the device.
        ...
        protected void onPostExecute(Bitmap bitmap) {
            ...
            // Releasing the orientation lock
